                ...
                <div id="contact" className="box-shadow-full">
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <div>
                        <form
                          action="https://formspree.io/gnanamozhi.it@gmail.com"
                          method="POST"
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="more-info">
                        <p className="lead">
                        Looking for a passionate, dedicated and creative Full Stack Web Developer? 
                        Contact me for more information on how I can help your team.
                          <br />
                          Simply fill the from and send me an email.
                        </p>
                        <ul className="list-ico">
                                <li><span className="ion-ios-location"></span> Ranipet/Tamilnadu, India</li>
                                <li><span className="ion-ios-telephone"></span> +91 9080946043</li>
                                <li><span className="ion-email"></span> {/* <a href="#" target="_blank" rel="noopener noreferrer"> */}<span>gnanamozhi.it@gmail.com</span></li>
                                </ul> 
                      </div>
